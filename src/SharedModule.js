...
const getSourceForDefaultCase = (
	...
	return Template.asString([
		'module.exports = ',
		`(typeof ${requestScope} !== 'undefined') ? typeof __webpack_require__.shared === 'function' ? (__webpack_require__.shared('${request}') || Promise.resolve(__webpack_require__('${request}'))) : Promise.resolve(__webpack_require__('${request}')):`,
...
export default class SharedModule extends Module {
	 ...
	 */
	identifier() {
		return 'shared ' + JSON.stringify(this.request);
	}
	...
	build(options, compilation, resolver, fs, callback) {
		...
		this.buildInfo = {
			strict: true,
			exportsArgument: ['exports', '__webpack_require__'],
		};
